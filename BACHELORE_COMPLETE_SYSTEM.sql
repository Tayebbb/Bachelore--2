...
ALTER TABLE dbo.HOUSECONTACTS ADD CONSTRAINT FK_HOUSECONTACTS_USER FOREIGN KEY (user_id) REFERENCES dbo.USERS(user_id) ON UPDATE CASCADE ON DELETE CASCADE;
GO
