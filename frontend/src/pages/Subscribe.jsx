          ...
          <div className="auth-card p-4 mx-auto" style={{ maxWidth: "1100px" }}>
            <div className="row g-4">
              <div className="col-12 col-lg-5">
                ...
                <p className="muted">
                  Choose the plan that fits you. The subscription unlocks
                ...
                >
                  ...
                  <div className="mb-3">
                    ...
                    <div className="form-text">
                      Please transfer 99 Tk to our bKash number and enter the
                      transaction reference here. We'll verify and activate your
                      subscription.
                    </div>
                  </div>

                  <div className="d-flex align-items-center gap-3 mt-3">
                    <button className="btn hero-cta px-4 py-2" type="submit">
                      {status === "loading"
                        ? "Processing..."
