...
import AdminTuitionReviewPage from "../pages/admin/AdminTuitionReviewPage.jsx";
import AdminHouseRentReviewPage from "../pages/admin/AdminHouseRentReviewPage.jsx";
import AdminMaidServiceReviewPage from "../pages/admin/AdminMaidServiceReviewPage.jsx";
import AdminMarketplaceReviewPage from "../pages/admin/AdminMarketplaceReviewPage.jsx";
...
import StudentAnnouncementPage from "../pages/student/StudentAnnouncementPage.jsx";
...
export default function Router() {
  const appShellRoutes = new Set([
    ...
    "/admin/users",
    "/admin/listings",
    "/admin/tuition-review",
    "/admin/houserent-review",
    "/admin/maid-service-review",
  ...
  const hideGlobalNavbar =
    hideGlobalChrome || appShellRoutes.has(location.pathname);
  return (
      ...
      <div className="app-content">
        <Routes>
          ...
          >
            ...
            <Route path="announcements" element={<StudentAnnouncementPage />} />
          ...
          >
            ...
            <Route path="tuition-review" element={<AdminTuitionReviewPage />} />
            <Route path="houserent-review" element={<AdminHouseRentReviewPage />} />
            <Route path="maid-service-review" element={<AdminMaidServiceReviewPage />} />
            <Route path="marketplace-review" element={<AdminMarketplaceReviewPage />} />
